"""
The middleware refuses the request, not just the table saying it should — a
correct table wired in wrongly is still an open door.
...
def _build(tmp: Path):
    ...
    async def setup():
        ...
        # A companion phone: must not be able to reach the editor.
